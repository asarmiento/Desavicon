                ...
                <div class="flex justify-between h-16">
                    <div class="flex">
                        ...
                        <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                            ...
                            <nav-link href="/register-customer" :active="$page.currentRouteName == 'register-customer'">
                                Registro de Clientes
                            </nav-link>
                            <nav-link href="/list-customers" :active="$page.currentRouteName == 'list-customers'">
                                Lista de Clientes
                            </nav-link>
                            <nav-link href="/list-proform" :active="$page.currentRouteName == 'list-proform'">
                                Lista de Proformas
                            </nav-link>
                        </div>
                    </div>
...
<script>
    ...
    import NavLink from './../Pages/Layaout/NavLink'
